...
<body>
	...
	<center><p>Don't have an account ? <a href="register.jsp" type="submit"> Register  </a></p></center>
	</form>
	<%
		...
		<%
				...
				{
		%>
				<h5 style="color: rgba(255, 165, 52, 1.00);"><u>Invalid Login ! Please enter valid data...</u></h5> 
		<%
				}
				}
			%>
