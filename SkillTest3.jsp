...
<div class="container-fliuid">
    ...
    <a href="Civil.jsp" class="btn btn-light my-2 my-sm-0 mr-2" name="btn4" id="blink_text" type="submit" style="color: #fff;background-color: #007bff;border-color: #007bff;border-radius:25px;width:15%;"> <b> Start Here</b></a>
</div><br><br>
	<div class="form-group">
