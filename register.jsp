...
<head>
	...
	<script>
		function validate()
		{
			...
			else if(! sname.value.match(/^[A-Za-z]+[gmail.com]$/))
			{
				alert("User Email should not be Empty");
				uemail.value="";
				uemail.focus();
...
<body>
	...
	<center><p>Already have an account ? <a href="login.jsp" type="submit"> Login  </a></p></center>
	</form>
	<%
				...
				{
			%>
				<h5 style="color: rgba(255, 165, 52, 1.00);"><u>User already exists ! Please enter valid data...</u></h5> 
			<%
				}
				}
			%>
